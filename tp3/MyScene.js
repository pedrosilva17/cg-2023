...
export class MyScene extends CGFscene {
    ...
    initLights() {
        this.globalLightValues = {
            "rgb": [76, 76, 76],
            "alpha": 1.0
        };
        this.setGlobalAmbientLight(
          ...this.globalLightValues["rgb"].map(x => x / 255), 1.0
        );
    ...
    updateGlobalLight() {
        this.setGlobalAmbientLight(...this.globalLightValues["rgb"].map(x => x / 255), 1.0);
    }
    ...
    initMaterials() {
        ...
        this.wood.setAmbient(0, 0, 0, 1.0);
        this.wood.setDiffuse(0.5, 0.2, 0, 1.0);
        this.wood.setSpecular(0.1, 0, 0, 1.0);
        this.wood.setShininess(5.0);
