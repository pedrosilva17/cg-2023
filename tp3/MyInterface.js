...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        var gl = this.gui.addFolder('Global Light')
        gl.addColor(this.scene.globalLightValues, 'rgb').onChange(this.scene.updateGlobalLight.bind(this.scene));
        gl.add(this.scene.globalLightValues, 'alpha', 0.0, 1.0).onChange(this.scene.updateGlobalLight.bind(this.scene));
